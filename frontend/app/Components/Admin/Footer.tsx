        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-8">
          ...
          <div className="flex flex-row gap-12 md:gap-24 flex-1 justify-center md:justify-start md:pl-20">
            ...
            <div className="flex flex-col gap-3.5">
              <Link href="/Admin/Home" className="hover:text-slate-200 transition-colors font-extrabold text-base no-underline">
                Home
              </Link>
              <Link href="/Admin/Claims" className="hover:text-slate-200 transition-colors font-extrabold text-base no-underline">
                Claims
              </Link>
              <Link href="/Admin/Registrations" className="hover:text-slate-200 transition-colors font-extrabold text-base no-underline">
                Registrations
              </Link>
              <Link href="/Admin/Contact" className="hover:text-slate-200 transition-colors font-extrabold text-base no-underline">
                Contact
              </Link>
            </div>
